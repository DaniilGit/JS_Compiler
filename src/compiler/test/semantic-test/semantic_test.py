...
test_paths = [
  ("example/example7.js", "src/compiler/test/semantic-test/right-test1.txt"),
  ("example/example8.js", "src/compiler/test/semantic-test/right-test2.txt")
]

output = "src/compiler/test/semantic-test/output.txt"
